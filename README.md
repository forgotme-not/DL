...
本项目记录鼠鼠学习深度学习与自然语言处理（NLP）的代码、手搓实现与实验 Notebook。
...
- [`d2l_7mlp.ipynb`](./d2l_7mlp.ipynb) - 多层感知机 (MLP)

### 🔹 二、 进阶与循环神经网络 (RNN Series)
- [`d2l_8 序列模型.ipynb`](./d2l_8%20序列模型.ipynb) - 序列模型与文本预处理
- [`d2l_9 RNN.ipynb`](./d2l_9%20RNN.ipynb) - 循环神经网络基础
- [`d2l_10 GRU.ipynb`](./d2l_10%20GRU.ipynb) - 门控循环单元 (GRU)
- [`d2l_11 LSTM.ipynb`](./d2l_11%20LSTM.ipynb) - 长短期记忆网络 (LSTM)

### 🔹 三、 “手搓”网络与原理实验
- [`手搓一个单层神经网络并训练.ipynb`](./手搓一个单层神经网络并训练.ipynb)
- [`从单层网络到深层网络.ipynb`](./从单层网络到深层网络.ipynb)
- [`手搓一个参数衰退.ipynb`](./手搓一个参数衰退.ipynb)
- [`张量实验&CNN尺寸推导.ipynb`](./张量实验&CNN尺寸推导.ipynb)
